...
public class Vehicle implements Comparable<Vehicle>, Setable {
    ...
    public Vehicle(String v, short mY, String m, String mN, String tL, int o, String tS, String dN, Boolean a) {
//        System.out.printf("%s\t%d\t%s\t%s\t%s\t%d\t%s\t%s\t%s\n",v,mY,m,mN,tL,o,tS,dN,a.toString());
        ...
        if((vin.getValue().compareTo("INVALID")==0) || (modelYear.getValue() == -1) || (maker.getValue().compareTo("INVALID") == 0) || 
        ...
        switch(args.length){
            case 9:
                setVehicle((String)args[0], (short)((int)args[1]), (String)args[2], (String)args[3], 
                        (String)args[4], (Integer)args[5], (String)args[6], (String)args[7], (Boolean)args[8]);
                break;
            default:
                setVehicle();
        }
    ...
    public void setVehicle(String v, short mY, String m, String mN, String tL, int o, String tS, String dN, Boolean a) {
//        System.out.printf("%s\t%d\t%s\t%s\t%s\t%d\t%s\t%s\t%s\n",v,mY,m,mN,tL,o,tS,dN,a.toString());
        this.setVin(v);
        this.setYear(mY);
        this.setMaker(m);
